@php use App\Enums\StatusPendaftaran; @endphp
<x-layouts.email>
    @section('content')
        <td align="center" data-bgcolor="Body" bgcolor="#F4F4F4" data-composer>
                                        ...
                                        <tr>
                                            <td class="rwd-col" align="center" width="46.66%"
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr data-element="colibri-preheader-18-title" data-label="Titles">
                                                        <td class="center-text" align="left"
                                                            style="font-family:'Poppins',Arial,Helvetica,sans-serif;
                                                            font-size:14px;line-height:12px;font-style:normal;
                                                            font-weight:700;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                            E-Tiket Bantaeng Trail Run 2025
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                                            ...
                                            <td class="rwd-col" align="center" width="46.66%"
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                       role="presentation" width="100%"
                                                       style="width:100%;max-width:100%;">
                                                    <tr data-element="colibri-preheader-18-webview"
                                                        data-label="Webview">
                                                        <td class="center-text" align="right"
                                                            style="font-family:'Poppins',Arial,Helvetica,sans-serif;
                                                            font-size:14px;line-height:12px;font-style:normal;
                                                            font-weight:700;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                            Vibrate Your Motion In Nature
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                            ...
                            <tr data-element="colibri-preheader-18-logo" data-label="Logo">
                                <td align="center" class="center-text">
                                    <img style="width:200px;border:0px;display: inline!important;"
                                         src="{{ asset('frontend/running/Logo_2.png') }}" width="120" border="0"
                ...
                <tr>
                    <td align="center" data-fallback-color="Fallback Color" bgcolor="#fafafa">
                        ...
                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:640px;">
                            <v:fill origin="0.5, 0.5" position="0.5, 0.5" src="{{ asset('email/header-18-back.png') }}"
                                    type="tile"
                                    size="1,1" aspect="atleast"></v:fill>
                            <v:textbox style="mso-fit-shape-to-text:true;" inset="0,0,0,0">

                                <div>
                                    <!-- colibri-header-18-bg-image -->
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                           width="100%" style="width:100%;max-width:100%;">
                                        <tr>
                                            <td align="center" background="{{ asset('email/header-18-back.png') }}"
                                                data-bg-image
                                                {{--                                            <td align="center" background="{{ asset('frontend/running/Background Earlybird.png') }}"--}}
                                                data-bg-image
                                                data-label="Background image" data-bg-size="640,530"
                                                style="background-size:cover;background-position:center top;">

                                                <!-- Content -->
                                                <table data-inner-table border="0" align="center" cellpadding="0"
                                                       cellspacing="0" role="presentation" class="inner-table row"
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            ...
                                                            <table border="0" align="center" cellpadding="0"
                                                                   cellspacing="0" class="row container-padding"
                                                                   role="presentation" width="82.76%"
                                                                   style="width:82.76%;max-width:82.76%;">
                                                                <tr>
                                                                    <td align="center"
            ...
            <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row"
                   role="presentation" width="640" style="width:640px;max-width:640px;"
                   data-module="colibri-basic-message-18">
                        ...
                        <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr data-element="colibri-bm-paragraph" data-label="Paragraphs">
                                <td class="center-text" data-text-style="Paragraphs" align="center"
                                    ...
                                    <singleline>
                                        <div mc:edit data-text-edit>
                                            Print e-Tiket ini dan tunjukkan saat akan melakukan check-in. E-Tiket ini
                                            hanya valid untuk 1 kali check-in. Syarat dan ketentuan mengikuti
                                            penyelenggara acara.
                                        </div>
                                    </singleline>
                                </td>
                            ...
                            <tr data-element="colibri-invoice-info" data-label="Invoice Info">
                                <td align="center" data-border-radius-default="0,6,36"
                                    data-border-radius-custom="Emoji Container" data-bgcolor="Emoji Container"
                                    bgcolor="#F4F4F4" style="border-radius: 6px; border: 2px dotted #EEEEEE;">
                                    <!-- Content -->
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                           class="row" width="89.66%" style="width:89.66%;max-width:89.66%;">
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center">
                                                <!-- rwd-col -->
                                                <table border="0" cellpadding="0" cellspacing="0" align="center"
                                                       class="container-padding" width="100%"
                                                       style="width:100%;max-width:100%;">
                                                    <tr>
                                                        <td class="rwd-col" align="center" valign="top" width="48.96%"
                                                        ...
                                                        <td class="rwd-col" align="center" width="2.08%" height="30"
                                                                ...
                                                                <tr data-element="colibri-content-paragraph"
                                                                    ...
                                                                    <td class="center-text" data-text-style="Paragraphs"
                                                                        ...
                                                                        <singleline>
                                                                            <div mc:edit data-text-edit>
                                                                                Rp. {{ Number::format
                                                                                ($pembayaran->total_harga, 0, locale: 'id') }}
                                                                            </div>
                                                                        </singleline>
                                                                    </td>
                                                                </tr>
                            ...
                            <tr data-element="colibri-invoice-info" data-label="Invoice Info">
                                <td height="25" style="font-size:25px;line-height:25px;"
                                    data-height="Spacing under invoice info">&nbsp;
                                </td>
                            </tr>
                            <tr data-element="colibri-bm-paragraph" data-label="Paragraphs">
                                <td class="center-text" data-text-style="Paragraphs" align="center"
                                    ...
                                    <singleline>
                                        <div mc:edit data-text-edit>
                                            Jika ada pertanyaan atau saran silahkan hubungi <a
                                                href="https://wa.me/6285667863176?text=urlencodedtext"
                                                style="color:#E38529;text-decoration: underline;">Panitia</a>
                                        </div>
                                    </singleline>
                                </td>
                            </tr>
                    ...
                    <td align="center">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <td align="center">
                                                <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td align="center">
                                                                        <img
                                                                            ...
                                                                            src="{{ asset('email/Facebook.png') }}"
                                                                            width="36"
                                                                            border="0" editable="true" data-icon
                                                                            data-image-edit
                                                                            data-url="https://registrasi.test/email/Facebook.png"
                                                        ...
                                                        <td data-element="colibri-footer-instagram"
                                                            data-label="Instagram" class="rwd-on-mobile" align="center"
                                                            valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0"
                                                                   cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td class="center-text" data-text-style="Paragraphs" align="center"
                                                ...
                                                <multiline>
                                                    <div mc:edit data-text-edit>
                                                        2024 Freeletics Bantaeng. All Rights Reserved.
                                                    </div>
                                                </multiline>
                                            </td>
                                        </tr>
                            ...
                            <tr data-element="colibri-footer-logo" data-label="Logo on Footer">
                                <td height="30" style="font-size:30px;line-height:30px;"
                                    data-height="Spacing under logo">&nbsp;
                                </td>
                            </tr>
                            <tr data-element="colibri-footer-logo" data-label="Logo on Footer">
                                <td align="center" class="center-text">
                                    <img style="width:200px;border:0px;display: inline!important;"
                                         src="{{ asset('frontend/running/Logo_3.png') }}"
